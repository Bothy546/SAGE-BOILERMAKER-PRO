...
sealed class Screen(val route: String, val label: String, val icon: ImageVector) {
    ...
    object Projects : Screen("projects", "Projects", Icons.Filled.ListAlt)
}

val bottomNavItems = listOf(Screen.Dashboard, Screen.Calculators, Screen.Library, Screen.Safety, Screen.Projects)
